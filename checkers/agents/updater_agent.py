...
def updater_agent(state: CheckersState) -> dict:
    """
    ...
    _eval_proposal_diagnostics = state.proposer_diagnostics
    ...
    _log_state = post_wc_state.model_copy(
        update={
            ...
            "proposer_diagnostics": _eval_proposal_diagnostics,
        }
    )
    ...
    merged["last_completed_node"] = "updater_agent"
    return merged
